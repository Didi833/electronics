...
/* ============================================================================
   GOON CORNER — 20 SFW, fully-dressed, ORIGINAL full-body anime-girl ASCII figures.
   Generic outfits/hairstyles only — none are real or copyrighted characters.
   { n: name, d: outfit/style, a: art }
   ========================================================================== */
function goonFig(top, eL, eR, mo, dec, sk){
  return [
    "   ."+top+".   ",
    "  ╭───────╮  ",
    "  ┤ "+eL+"   "+eR+" ├  ",
...
const GOON = [
  { n:"Aoi",  d:"sailor uniform",  a:goonFig("◖▓▓◗","◕","◕","◡","⚓","░") },
  { n:"Mika", d:"summer sundress", a:goonFig("❀❀❀","^","^","ω","✿","▒") },
  { n:"Yuki", d:"winter coat",     a:goonFig("☆彡","•","•","‿","❄","█") },
  { n:"Sora", d:"hoodie + jeans",  a:goonFig("◜◝","◔","◔","ε","♪","░") },
  { n:"Nana", d:"flower kimono",   a:goonFig("⌒⌒⌒","◑","◐","ω","✾","▒") },
  { n:"Emi",  d:"denim overalls",  a:goonFig("╱╱╱","˘","˘","ᴗ","◆","░") },
  { n:"Rin",  d:"magical-girl dress", a:goonFig("★ ★","◠","◠","▽","✦","▒") },
  { n:"Saki", d:"school skirt",    a:goonFig("◞◟","●","●","３","✚","░") },
  { n:"Mei",  d:"cat hoodie",      a:goonFig("◖^◗","◕","◔","‿","ฅ","▒") },
  { n:"Yua",  d:"gym uniform",     a:goonFig("～～","´","`","▿","☄","░") },
  { n:"Koko", d:"lolita dress",    a:goonFig("◍◍","⚆","⚆","o","♛","▒") },
  { n:"Hana", d:"floral yukata",   a:goonFig("❁❁","◉","◉","‸","❁","▒") },
  { n:"Riko", d:"maid dress",      a:goonFig("◖♥◗","＾","＾","ω","♡","░") },
  { n:"Miu",  d:"idol stage outfit", a:goonFig("✦✦","◝","◜","◡","♬","▒") },
  { n:"Aya",  d:"raincoat",        a:goonFig("☂☂","｡","｡","～","☂","░") },
  { n:"Chii", d:"witch robe",      a:goonFig("✦◞◟","¬","¬","ε","✶","█") },
  { n:"Tama", d:"nurse outfit",    a:goonFig("✚✚","◕","◕","▽","✚","░") },
  { n:"Nori", d:"flight jumpsuit", a:goonFig("◣◢","ô","ô","‿","✈","▒") },
  { n:"Hina", d:"party dress",     a:goonFig("✿✿","◕","◕","ω","♥","▒") },
  { n:"Suki", d:"tracksuit",       a:goonFig("◜◜",">","<","◡","➤","░") }
];
